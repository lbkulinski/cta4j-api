package app.cta4j.aws.client;

import app.cta4j.aws.dto.Secret;
import app.cta4j.aws.exception.SecretsClientException;
...
public final class AwsSecretsClient {
    ...
    public AwsSecretsClient(
        ...
        @Value("${app.aws.secrets-manager.secret-id}") String appSecretId
    ) {
